...
<div id="no-sidebars">
  <div class="dashboard-report">
    ...
    <?php if ($section == "batch_stages"): ?><li class="list_header">by workflow stage</li><?php endif; ?>
    <?php if ($section == "batch_priorities"): ?><li class="list_header">by priority</li><?php endif; ?>
    <?php if ($section == "batch_content_types"): ?><li class="list_header">by content type</li><?php endif; ?>
